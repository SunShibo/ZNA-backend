<template> <!--以修改-->
    <div class="table">
        ...
        <div class="container">
            ...
            >
                <el-table-column label="中文标题"  prop="title"></el-table-column>
                <el-table-column label="英文标题"  prop="titleEnglish"></el-table-column>
                <el-table-column label="中文内容"  prop="context"></el-table-column>
                <el-table-column label="英文内容"  prop="contextEnglish"></el-table-column>
                ...
                <el-table-column label="图片" prop="url" width="80">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 获取 easy-mock 的模拟数据
            getData() {
                this.$axios.post("/aboutBanner/selectAboutBanner", this.search)
                    .then(res => {
            ...
            saveEdit() {
               ...
               if (!fd.pictureUrl) {
                ...
                if (this.form.id == "") {
                    delete fd.id;
                    this.$axios.post("/aboutBanner/addAboutBanner", fd).then(res => {
                        if (!res.success) {
                    ...
                    //编辑
                    this.$axios.post("/aboutBanner/updateAboutBanner", fd).then(res => {
                        if (!res.success) {
            ...
            deleteRow() {
                this.$axios
                    .post("/aboutBanner/removeAboutBanner", {id: this.form.id})
                    .then(res => {
                        if (!res.success) {
                            this.$message.success(res.errMsg);
                            return;
