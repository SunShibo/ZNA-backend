    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 关于我们服务模块
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            >
                ...
                <el-table-column label="背景图片" prop="pictureUrl" >
        ...
        <!--富文本编辑-->
        <el-dialog     title="内容编辑" :visible.sync="bcontext" width="70%" :close-on-click-modal="closeOnClickModal">
            <el-form ref="form" :model="form" label-width="100px">
                <el-row :gutter="20">
                    <el-col :span="12">
                        中文:
            ...
            <span slot="footer" class="dialog-footer">
                <el-button class="editor-btn" type="primary"  @click="bcontext = false">取消</el-button>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 获取 easy-mock 的模拟数据
            getData() {
                this.$axios.post("/service/getservice", this.search)
                    .then(res => {
                        this.tableData=[];
            ...
            contextSave(){
                ...
                //编辑
                this.$axios.post("/service/updateservice", fd).then(res => {
                    if (!res.success) {
